...
@RestController
@RequestMapping("/nvp")
public class NVPDoExpressCheckoutPaymentController {

    @PostMapping("DoExpressCheckoutPayment")
    public String doExpressCheckoutPayment(@RequestParam String token,@RequestParam String payerId,@RequestParam String paymentAction,@RequestParam String amt){
        String responseBody ="";
        try {    
            ...
            params.add(new BasicNameValuePair("PAYMENTREQUEST_0_PAYMENTACTION", paymentAction));
